        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                ...
                <form action="{{ url('admin/add-employee') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label>Email</label>
                        <input type="email" id="email" name="email" class="form-control" placeholder="Employee email">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" id="password-confirm" name="password-confirm" class="form-control" placeholder="re-enter password">
                    </div>
